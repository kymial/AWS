...
export default function InputBox({ label, type, value, placeholder, onChangeHandler, onButtonClickHandler ,buttonTitle, buttonStatus, message, error }: InputBoxProps) {
