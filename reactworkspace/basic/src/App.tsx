...
// render () 함수의 반환 값으로 랜더링 하고자 하는 요소를 지정
...
// * ES7 + React/Redux/React-Native snippets 확장을 설치한 후 단축 명령으로 클래스형 혹은 함수형 컴포넌트를 생성 할 수 있다.

// * 클래스형은 rcc 단축 명령으로 생성 가능
