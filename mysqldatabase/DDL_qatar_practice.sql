...
-- country (name[가변문자열 30], group_name[가변문자열 1], manager[가변문자열 30], lanking[정수])
CREATE TABLE qatar_asian_cup.country(
	name VARCHAR(30),
...
-- stadium (name[가변문자열 50], capacity[정수], address[가변문자열 255])
CREATE TABLE qatar_asian_cup.stadium(
	name VARCHAR(50),
    capacity INT,
    address VARCHAR(255)
);
...
-- player (name[가변문자열 30], age[정수], position[가변문자열 15], pro_team[가변문자열 30], uniform_number[정수], country[가변문자열 30])
CREATE TABLE qatar_asian_cup.player(
	name VARCHAR(30),
    age INT,
    position VARCHAR(15),
    pro_team VARCHAR(30),
...
-- referee (name[가변문자열 30], age[정수], position[가변문자열 15])
CREATE TABLE qatar_asian_cup.referee(
	name VARCHAR(30),
    age int,
    position VARCHAR(15)
);
...
-- game (schedule[날짜및시간], country1[가변문자열 30], country2[가변문자열 30], stadium[가변문자열 50], chief_referee[가변문자열 30], second_referee[가변문자열 30], winning_country[가변문자열 30])
CREATE TABLE qatar_asian_cup.game(
	schedule DATETIME,
    country1 VARCHAR(30),
    country2 VARCHAR(30),
    stadium VARCHAR(50),
