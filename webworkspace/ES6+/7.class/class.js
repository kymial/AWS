/*
    클래스 정의 : 
    - class 키워드를 사용하여 선언
    - constructor를 이용해서 맴버 변수를 선언 및 초기화를 할 수 있음
    - 생성자에서 this를 이용해서 맴버 변수를 지정
...
/*
    ...
    - 생성자안에서 this 키워드를 이용해서 클래스의 맴버변수를 선언하고 초기화 할 수 있음
...
const sample1Instance = new Sample1('퍼블릭 월드', '프라이빗 필드');
...
/*
    getter, setter : 
    - getter : 프라이빗 맴버 변수의 값을 얻을 수 있는 캡슐화 메서드
    - setter : 프라이빗 맴버 변수의 값을 할당 할 수 있는 캡슐화 메서드
*/
class Sample2{
    #privateField;
