...
public class EstateEntity {
    ...
    private Double leaseRatio40;        // 40m2 이하 매매가 대비 전세가
    private Double leaseRatio4060;      // 40m2 초과 60m2 이하 매매가 대비 전세가
    private Double leaseRatio6085;      // 60m2 초과 85m2 이하 매매가 대비 전세가
    private Double leaseRatio85;        // 85m2 초과 매매가 대비 전세가
    ...
    private Double monthRentRatio85;    // 40m2 초과 전세가 대비 월세 보증금 비율
