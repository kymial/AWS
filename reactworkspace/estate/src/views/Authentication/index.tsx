    ...
    return (
        <div className="authentication-contents">
            ...
            <div className="authentication-input-container">
                ...
                <InputBox label="아이디" type="text" value={id} placeholder="아이디를 입력해주세요" onChangeHandler={onIdChangeHandler} buttonTitle="중복 확인" buttonStatus={idButtonStatus} onButtonClickHandler={onIdButtonClickHandler} error={false} message="사용이 가능한 아이디입니다."/>
