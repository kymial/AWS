...
public class AuthServiceImplementations implements AuthService {
    ...
    public ResponseEntity<ResponseDto> signUp(SignUpRequestDto dto) {
        ...
        try{
            ...
            // 1-1 (1)에 대한 조회결과가 true 중복된 이메일 응답 처리
