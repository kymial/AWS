...
/*
    배열의 요소 추가
    - 배열[인덱스] = 값 : 요소 추가 가능, 순서를 생각할 필요는 없다.
...
/*
    - for - in 순회방식은 index를 사용하여 한번 더 작업해야하기 때문에 요소를 읽어들이는 순회에는 적합하지 않을 수 있음
...
/*
    indexOf(element) : 
    - 배열에서 매개변수로 전잘된 요소를 검색하여 해당 인덱스를 반환
...
/*
    includes(element) :
    - 배열에 매개변수로 전달된 요소가 존재하면 true, 존재하지 않으면 false로 반환
*/
...
/*
    push(element) :
    - 배열에 마지막 인덱스 요소를 추가하고 변경된 길이를 반환
*/
