...
/*
    블록 레벨 스코프 : 
    - 모든 코드 블록 내에서 선언된 변수는 해당 코드 블록 내에서만 사용 가능
*/
{
    var funcLevel = 10;
}
...
/* 블럭 레벨 변수는 해당 블럭 외부에서 사용이 불가능
{
    let blockLevel = 10;
}
console.log(blockLevel);
*/ // let은 괄호 안에서만 사용가능하고 나가면 사라진다.
...
/*
    호이스팅 : 
    - var, function 선언문을 최상단에 선언한 것 처럼 동작하는 특성
...
/*
    ...
    - 재활당이 발생하는 변수에는 let을 사용함
    - 재활당이 일어나지 않는 변수에는 const를 사용함
*/