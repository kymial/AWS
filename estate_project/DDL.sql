-- Active: 1706776140889@@127.0.0.1@3306@estate
# Entity
#   - 사용자
#   - 이메일 인증번호
#   - 게시물
...
# user_email : VARCHAR(100) NU UQ FK email_auth_number(email)
# user_role : VARCHAR(15) NU DEFAULT('ROLE_USER') CHECK('ROLE_USER','ROLE_ADMIN')
# join_path : VARCHAR(5) NU DEFAULT('HOME') CHECK('HOME', 'KAKAO', 'NAVER')
