...
// 선대입 후 증가
result = single++ * 8;  //0 ( (0*8)++)

//  선증가 후 대입
result = ++single * 8;  // 16 위에서 single이 1 증가해서 여기서는 2가 됨 ((1++)*8)
...
/*
    삼항 연산자 : 
    - 조건식의 논리 결과에 따라 반환할 결과를 서로 다른 결과를 반환
        -  조건식 ? true 일 때 반환  : false일 때 반환값
*/
const number = 9;
...
/*
    ...
    - 후에 나온 값이 결과 값이 나온다.
*/
console.log(true || '홍길동');  // or 같은 경우 처음에 true이면 어차피 뒤에는 읽지 않기때문에 얘는 true값이 나옴
