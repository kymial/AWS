package com.jungyoungjong.basic.config;
...
public class WebSecurityConfig {
    ...
    protected SecurityFilterChain configure(HttpSecurity security) throws Exception {
        ...
        //  - REST API 서버에서는 사용자 정보 빛 상태를 클라이언트가 유지하기 때문에 seesion을 생성 하지 않음

        // cookie :
        //  - 웹 에플리케이션에서 사용자의 대한 정보 및 상태를 유지하기 위한 기술
        ...
        // cache :
        //  - 데이터 나 값을 미리 복사해두고 저장하는 임시 공간
        //  - 사용자의 접근을 좀 더 빠르게 할 수 있도록 함
        //  - 시스템 성능 향상
       ...
       // CSRF (Cross-Site Request Forgery): 
        ...
        // 요청 URL 의 패턴에 따라 리소스 접근 허용 범위를 지정
        //  - 인증되지 않는 사용자도 접근을 허용
